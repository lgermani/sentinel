...
/**
 * @author sahajamit
 * github https://gist.github.com/sahajamit
 */

public class StaleElementUtils {

    final static org.apache.logging.log4j.Logger LOGGER = LogManager.getLogger(StaleElementUtils.class);
        ...
        try{
            ...
            for(String s:arr){
                ...
                if(leftBracketsCount-rightBracketscount==1)
                    value = value + "]";
                if(lastObject==null){
                    lastObject = WebDriverManager.getDriver();
                }else{
