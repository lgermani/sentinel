package com.github.lgermani.sentinel.core.selenium.factory.internal;
...
import static com.github.lgermani.sentinel.core.selenium.factory.internal.ImplementedByProcessor.getWrapperClass;
    ...
    public Object invoke(Object object, Method method, Object[] objects) throws Throwable {
       final WebElement element;
        try {
            ...
            }else if ("isPresent".equals(method.getName())) {
                return false;
            }
            throw e;
        }
